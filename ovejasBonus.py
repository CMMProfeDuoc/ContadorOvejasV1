...
#insertar ovejas - BONUS 1
while (True):
    system("cls")
    color = input("Ingrese el color a agregar").lower()
    if (color in ovejas_color):
        print("Color ya existente, no se puede agregar")
    else:
        precio = input("Ingrese el valor de las ovejas agregadas")

    salir = input("Desea agregar otra oveja? <si> <no>")
    if (salir == "no"):
        break
...
#Aplicar bonus a ganancias - BONUS 2
#desucento ovejas blancas
